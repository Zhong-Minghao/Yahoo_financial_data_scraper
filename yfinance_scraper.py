...
def main():
    ...
    # stocks = ['AAPL', 'GOOG', 'NOW', 'CSCO', 'VZ', 'NVDA']
    ...
    output_directory = r'./data_download'
    ...
    for i in range(len(stocks)):
        ...
        test_url = f'https://finance.yahoo.com/quote/{stock}/financials'
        payload = {'p': stock}
        response = requests.get(test_url, params=payload, headers=headers)
        if not response.history:
            ...
            # valuation_measures, misc_data = run.scrape_key_statistics_data()
